# [Punitha - Free Bootstrap 4 UI Kit](https://demos.creative-tim.com/paper-kit-2-angular/)
...
![Punitha](https://s3.amazonaws.com/creativetim_bucket/products/65/original/opt_pk2_angular_thumbnail.jpg "Punitha Free")

Punitha is a free Bootstrap 4 UI Kit with pale colors, beautiful typography built for Angular 7.
...
Punitha is using Ng Bootstrap (https://ng-bootstrap.github.io/#/home), as core framework.

**Bootstrap 4 support**

Punitha is built on top of Bootstrap 4, so it fully supports it. Most of the elements from the framework are re-designed to resemble sheets of paper and color pastels. If the are elements that we have not touched, they will gracefully fall back to the Bootstrap 4 default.
...
| HTML | Angular |
| --- | --- |
| ![Paper Kit 2 HTML](https://s3.amazonaws.com/creativetim_bucket/products/61/opt_pk2_thumbnail.jpg) | ![Punitha](https://s3.amazonaws.com/creativetim_bucket/products/65/opt_pk2_angular_thumbnail.jpg)
...
## Reporting Issues
We use GitHub Issues as the official bug tracker for the Punitha. Here are some advices for our users that want to report an issue:

1. Make sure that you are using the latest version of the Punitha. Check the CHANGELOG from your dashboard on our [website](https://www.creative-tim.com/).
